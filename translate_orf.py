...
# This script translates the first open reading frame (ORF) found in a nucleotide sequence 
# to standard output.
...
def main():
    ...
    transorf = translate.translate_sequence(rna_sequence = orf, genetic_code = genetic_code)
    sys.stdout.write('{}\n'.format(transorf))
